    ...
    switch(getch()) { // the real value
            ...
            //shoot logic
                ...
                if(turn<=6){
                  ...
                  bb.sortingArrayLeaderBoardOnly(); // sorting
            ...
            case 's': // press s to save
                ...
                bb.writeToScoreFile(); // write scores to file (append)
...
cout<<"This is high score board"<<endl<<endl;
  ...
  bb.sortingArrayLeaderBoard(); // sorting and show
