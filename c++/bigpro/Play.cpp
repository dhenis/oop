...
int* Play::setArrayScore(){
  ...
  for(int o =0; o<=6; o++){
      ...
      tempArray[o] = -1;  // score default becomes 1
...
void Play::writeToPlayerNameFile(string p1, string p2){
  ...
  void Play::sortingArrayLeaderBoardOnly(){

    string ipt = "file_sys/leader_board.txt";

    string array[2];
    string string_array[100][2]; // max 100 line
    int fstElement[100];
  ...
  void Play::sortingArrayLeaderBoard(){
    ...
    string array[2];
    string string_array[100][2]; // 100 lines  maximal
    int fstElement[100];
